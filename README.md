...
<h3 align="center">cloud & Infrastructure Automation | AWS | Azure | Kubernetes</h3>
...
- Built pipeline for build & deployment automation  

### 🔹 AWS Hands-on
- EC2, IAM, VPC setup and configuration  
